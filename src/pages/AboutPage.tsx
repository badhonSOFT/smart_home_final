  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-24">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6">
            <Card className="p-8 bg-white rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
              <h3 className="text-2xl font-bold text-black mb-6 text-center">Our Promise:</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700 text-lg">No fakes — only authentic, tested products</span>
                </div>
                <div className="flex items-start space-x-3">
                  <Check className="w-6 h-6 text-green-600 flex-shrink-0 mt-0.5" />
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-4xl mx-auto px-6">
            <Card className="p-8 bg-gray-900 text-white rounded-2xl shadow-xl hover:shadow-2xl transition-shadow">
              <h3 className="text-2xl font-bold mb-8 text-center">Brand Layer</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-xl font-semibold mb-4 text-blue-300">SOHUB (mother brand)</h4>
                ...
                <div>
                  <h4 className="text-xl font-semibold mb-4 text-green-300">#BuiltForComfort (first initiative)</h4>
                  <p className="text-gray-300 leading-relaxed">

      ...
      <main className="pt-16">
        ...
        <section className="py-32 bg-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h1 className="text-6xl md:text-7xl font-bold text-black mb-8 tracking-tight leading-none">
              #BuiltForComfort
            </h1>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-20">
              <h2 className="text-5xl font-bold text-black mb-6">Our Philosophy</h2>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-black mb-4">Precision</h3>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-20">
              <h2 className="text-5xl font-bold text-black mb-6">Built Different</h2>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              <div className="space-y-12">
                <div>
                  <h3 className="text-2xl font-bold text-black mb-4">Premium Components</h3>
                ...
                <div>
                  <h3 className="text-2xl font-bold text-black mb-4">Smart Integration</h3>
                  <p className="text-gray-600 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-black mb-4">Professional Installation</h3>
                  <p className="text-gray-600 text-lg leading-relaxed">
              ...
              <div className="space-y-12">
                <div>
                  <h3 className="text-2xl font-bold text-black mb-4">Whisper Quiet</h3>
                  <p className="text-gray-600 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-black mb-4">Fail-Safe Design</h3>
                  <p className="text-gray-600 text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-black mb-4">Lifetime Support</h3>
                  <p className="text-gray-600 text-lg leading-relaxed">
        ...
        <section className="py-32 bg-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-5xl font-bold text-black mb-8">Ready to Transform Your Space?</h2>
            <p className="text-xl text-gray-600 mb-12 leading-relaxed">
              Experience the future of home automation with Curtain Luxe.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Button className="bg-black text-white hover:bg-gray-800 px-12 py-4 text-lg font-medium rounded-full transition-all duration-300">
                Schedule Consultation
              </Button>
              <Button variant="outline" className="border-2 border-black text-black hover:bg-black hover:text-white px-12 py-4 text-lg font-medium rounded-full transition-all duration-300">
                View Gallery
              </Button>
            </div>
          </div>

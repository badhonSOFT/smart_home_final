  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-16">
        ...
        {/* Experience Section */}
        <BackgroundBeamsWithCollision className="py-16 md:py-24 bg-black text-white from-black to-black dark:from-black dark:to-black">
          <div className="max-w-4xl mx-auto px-4 md:px-6 text-center relative z-20">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 md:mb-8">The Experience</h2>
            <p className="text-base md:text-xl text-gray-300 mb-12 md:mb-16 leading-relaxed">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8 text-left">
              <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-6 md:p-8">
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">Morning Routine</h3>
              ...
              <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-6 md:p-8">
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">Away Mode</h3>
                <p className="text-sm md:text-base text-gray-400 leading-relaxed">
              ...
              <div className="bg-gray-900/80 backdrop-blur-sm rounded-2xl p-6 md:p-8">
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">Evening Comfort</h3>
                <p className="text-sm md:text-base text-gray-400 leading-relaxed">
